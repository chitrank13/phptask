...
<html>
<head>
<title>Wel come to Quiz game</title>
...
{
echo "<h1 class='style8' align=center>Wel come to Quiz game</h1>";
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
        <h1 class="style8">Wel come to Quiz game</h1>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p align="left" class="style5"><span class="style7">Wel Come to Quiz Game
            . This  will provide the quiz on the basis of General Knowledge. 
            You need to login for the take the Quiz game.</span></p>
      </blockquote>
    </div></td>
